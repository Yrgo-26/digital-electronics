"""Shared drawing style and rendering plumbing for the course figures.
...
Copied from the QAcademy assembly course, which drew mostly *fields* (a register split into
named bits, an address space split into regions) and so needed fills as well as strokes. This
course draws those too, plus gate networks, contact networks and timing diagrams, and all of
them use the same inks, weights and sizes defined below.
"""
